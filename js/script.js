...
function initLanguageSelector() {
  ...
  const defaultTranslations = {
    en: {
      ...
      portfolio: "Portfolio",
      contact: "Contact",
      hero_title: "Designing the Future of Map Apps",
      hero_desc: "We craft elegant, high-performance map experiences powered by AI and spatial data.",
      hero_cta: "Explore Our Services",
      about_title: "About Us",
      about_text: "AYA CLOUD is a studio focused on AI-driven map applications and spatial UX. We build tools that help businesses explore the world, visualize data, and create immersive digital twins. Our work blends design, performance engineering and geospatial research to deliver product-ready solutions.",
    ...
    zh: {
      ...
      portfolio: "项目",
      contact: "联系我们",
      hero_title: "设计AI地图应用的未来",
      hero_desc: "我们为数字世界创建优雅而强大的AI地图应用程序...",
      hero_cta: "探索我们的服务",
      about_title: "关于我们",
      about_text: "AYA CLOUD 是一家专注于人工智能和创新地图应用设计与构建的创意工作室。我们不仅仅想做易于理解、具有审美价值且富有交互性的地图应用，还希望逐步搭建一个开放、创新的地图平台。这个平台将整合来自全球的地理数据、用户贡献内容以及 AI 分析结果，成为一个支持多种场景、多种行业的地图生态系统。通过平台化设计，我们希望能够让个人开发者、企业和组织在同一个系统上协作，共同创造地图价值。无论是旅行打卡、运动记录、智慧城市，还是教育研究、文化传播，此平台都将提供丰富的工具和接口，成为连接现实世界与虚拟世界的核心基础设施之一。",
